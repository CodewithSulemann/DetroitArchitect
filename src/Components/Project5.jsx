...
import img1 from '../Assets/p/p5/1.png'
import img2 from '../Assets/p/p5/2.png'
import img3 from '../Assets/p/p5/3.png'
import img4 from '../Assets/p/p5/4.png'
  ...
  return (
    <div className='bg-gray-300'>
      ...
      <div className='container w-full px-6 py-18 text-center TEXT-BOLDER text-pink-600 '>
        <h1 className='text-5xl text-bold font-[Cormorant Garamond]'>Project 05</h1>
      </div>
